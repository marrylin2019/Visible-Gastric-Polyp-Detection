...
class DetMetrics:
    ...
    Attributes:
        ...
        speed (dict): A dictionary for storing the execution time of different parts of the detection models.

    Methods:
        models(tp, conf, pred_cls, target_cls): Updates the metric results with the latest batch of predictions.
...
class SegmentMetrics:
    ...
    Methods:
        models(tp_m, tp_b, conf, pred_cls, target_cls): Processes metrics over the given set of predictions.
...
class ClassifyMetrics:
    ...
    Methods:
        models(targets, pred): Processes the targets and predictions to compute classification metrics.
    """
